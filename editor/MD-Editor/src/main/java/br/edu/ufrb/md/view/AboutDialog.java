...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(RootFrame parent) {
...
//		cp.setBorder(empty5Border);
		...
		JLabel label = new JLabel("Matemática Dinâmica - Editor");
		...
		textArea.setText("Version 1.0\n\n" + 
			"Editor Latex adaptado para criação de artigos do site Matemática Dinâmica.\n" +
			"Suporte as linguagens Latex, HTML, CSS e PHP.");
		...
		setTitle("Sobre Matemática Dinâmica Editor");
		setContentPane(cp);
